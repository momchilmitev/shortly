	...
	return (
		<footer className="footer">
			<div className="footer__container">
				...
				<nav className="footer__navigation footer__navigation--features">
				...
				<nav className="footer__navigation footer__navigation--resources">
				...
				<nav className="footer__navigation footer__navigation--company">
